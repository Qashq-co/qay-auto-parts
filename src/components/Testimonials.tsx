...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-brand-lightBg relative overflow-hidden" id="testimonials">
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden rounded-2xl">
            <div
              ...
              style={{
                transform: `translateX(calc(-${activeIndex * (100 / 3)}% - ${activeIndex * (20 / 3)}px + ${100 / 3}% + ${20 / 3}px))`,
              }}
            >
              {reviews.map((rev, idx) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => goTo(idx)}
                    className={`
                      shrink-0 w-full md:w-[calc(33.333%-14px)] rounded-[20px] p-7 flex flex-col gap-5
                      relative overflow-hidden cursor-pointer transition-all duration-500 border
                      ${isActive
                    ...
                    <div className={`pt-4 border-t flex items-center justify-between gap-2 ${isActive ? 'border-white/10' : 'border-black/[0.06]'}`}>
                      <div>
                        ...
                        <p className={`text-[10px] font-bold uppercase tracking-wider mt-0.5 ${isActive ? 'text-orange-100/70' : 'text-gray-400'}`}>
                          {rev.location}{rev.location !== 'Verified Purchase' && ', UK'}
                        </p>
                      </div>
